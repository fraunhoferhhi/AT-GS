...
DATASET_DIR = '/media/hbr/storage/Kivi/decai/dynamic/3DGStream/submodules/DSINE/output/datasets/'   # where datasets are stored         NOTE: this should be changed!
EXPERIMENT_DIR = '/media/hbr/storage/Kivi/decai/dynamic/3DGStream/submodules/DSINE/output/experiments/'  # where to save the experiments     NOTE: this should be changed!
